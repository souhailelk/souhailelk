...
function ArticleComponent() {
  ...
  return (
    ...
    <div className="flex justify-center overflow-hidden px-6 py-4">
      <div className=" w-full h-full max-w-screen-xl shadow-lg overflow-auto">
        <img alt="Article" className="w-full h-[100px] md:h-[300px] lg:h-[400px] object-cover" src={article.mainImageUrl} />
